...
public class TicTacToe {
     ...
     * @param i contingut del element del tauler de joc  
     * @return Símbol '_' si i=-3; símbol 'O' si i=0; símbol 'X' si !=0
     */
    ...
    private static int bidimensionalToUnidimensional(int x, int y){
        return (y-1)*3 + x;
        /**
         * En aquest mètode el que fem es retornar el valor 
         * bidimensional a unidimensiolan (Fent la conversió).
         */
    }    
    ...
    /**
     * El Primer que fem es tenir les variables per a poder jugar
     * Amb el objecte "Rand" creat el que farem es demanar als usuaris introduir un número dintre del rang 1-3 per a jugar.
     * @param taulerJoc 
     */
